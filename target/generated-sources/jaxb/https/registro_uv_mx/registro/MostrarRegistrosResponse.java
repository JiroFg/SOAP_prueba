...
@XmlRootElement(name = "MostrarRegistrosResponse")
public class MostrarRegistrosResponse {

    @XmlElement(required = true)
    protected List<MostrarRegistrosResponse.Registro> registro;
     ...
     * {@link MostrarRegistrosResponse.Registro }
     * 
     * 
     */
    public List<MostrarRegistrosResponse.Registro> getRegistro() {
        if (registro == null) {
            registro = new ArrayList<MostrarRegistrosResponse.Registro>();
        }
